...
const generatepdffirstTimeuer = async (req, res) => {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-grey-m2" style="margin-left: 10%;">
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                                class="text-600 text-100" style="margin-right: 48px;">Sub Total</span>
                                            ${parseInt(req.body.rentToBePaid) + parseInt(req.body.electricitycharge) +
            parseInt(req.body.otherCharge) + parseInt(req.body.waterCharge)}</div>
                                    </div>
                                </td>
                            </tr>
...
const pdf = async (req, res) => {
    try {
        ...
        if (data) {
            if (data.theBillisFirstTime == true) {

                const updateUserfirstTime = await tenat.findByIdAndUpdate(data._id, { theBillisFirstTime: false })
                console.log(updateUserfirstTime)


                axios.post('http://15.207.39.254:7000/api/generatepdffirstTimeuer', data)
                    .then(response => {
...
module.exports = { generatepdf, pdf, generatepdffirstTimeuer };
